...
- **Light design system** — warm white palette with red/orange brand accents matching the Orme logo (recreated as `assets/logo.svg` — drop the original asset over that file to use it everywhere), Fraunces display serif paired with Inter, gradient text.
...
assets/logo.svg   # Brand mark (nav, footer, favicon)
